...
-- ============================================================
-- SECTION 4: DATABASE GRANTS - HEALTH_RAW_DB (2 schemas)
-- ============================================================

USE ROLE ACCOUNTADMIN;

CREATE DATABASE IF NOT EXISTS HEALTH_RAW_DB DATA_RETENTION_TIME_IN_DAYS = 90;
CREATE SCHEMA IF NOT EXISTS HEALTH_RAW_DB.CLINICAL_DATA;
CREATE SCHEMA IF NOT EXISTS HEALTH_RAW_DB.REFERENCE_DATA;
...
-- ============================================================
-- SECTION 5: DATABASE GRANTS - HEALTH_TRANSFORM_DB (2 schemas)
-- ============================================================

CREATE DATABASE IF NOT EXISTS HEALTH_TRANSFORM_DB DATA_RETENTION_TIME_IN_DAYS = 30;
CREATE SCHEMA IF NOT EXISTS HEALTH_TRANSFORM_DB.CLEANSED;
CREATE SCHEMA IF NOT EXISTS HEALTH_TRANSFORM_DB.MASTER;
...
-- ============================================================
-- SECTION 6: DATABASE GRANTS - HEALTH_ANALYTICS_DB (2 schemas)
-- ============================================================

CREATE DATABASE IF NOT EXISTS HEALTH_ANALYTICS_DB DATA_RETENTION_TIME_IN_DAYS = 90;
CREATE SCHEMA IF NOT EXISTS HEALTH_ANALYTICS_DB.CORE;
CREATE SCHEMA IF NOT EXISTS HEALTH_ANALYTICS_DB.REPORTING;
...
GRANT USAGE ON SCHEMA HEALTH_ANALYTICS_DB.CORE TO ROLE HEALTH_READONLY;
GRANT USAGE ON SCHEMA HEALTH_ANALYTICS_DB.REPORTING TO ROLE HEALTH_READONLY;
...
-- ============================================================
-- SECTION 7: DATABASE GRANTS - HEALTH_AI_READY_DB (2 schemas)
-- ============================================================

CREATE DATABASE IF NOT EXISTS HEALTH_AI_READY_DB DATA_RETENTION_TIME_IN_DAYS = 30;
CREATE SCHEMA IF NOT EXISTS HEALTH_AI_READY_DB.FEATURES;
CREATE SCHEMA IF NOT EXISTS HEALTH_AI_READY_DB.MODELS;
...
-- ============================================================
-- SECTION 8: DATABASE GRANTS - HEALTH_GOVERNANCE_DB (2 schemas)
-- ============================================================

CREATE SCHEMA IF NOT EXISTS HEALTH_GOVERNANCE_DB.MONITORING;
